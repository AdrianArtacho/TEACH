...
| [🕹DrumMachine](https://github.com/AdrianArtacho/teach_drummachine.git) | ![DR-3](img/dr3_main.jpg) | – |
| [🕹GroovePizza](https://github.com/AdrianArtacho/teach_GroovePizza) | Run GroovePizza locally | – |
| [🕹HearingTests](https://github.com/AdrianArtacho/teach_gehoertest.git) | https://AdrianArtacho.github.io/teach_gehoertest/ | – |
| [🕹Interactive](https://github.com/AdrianArtacho/teach_excerpts.git) | This app displays a piano roll, score (via OSMD), and an interactive keyboard. | – |
| [🕹Numeric](https://github.com/AdrianArtacho/teach_numeric.git) | This project renders an **interactive piano keyboard** based on a given MusicXML file. | – |
| [🕹SHOWING](https://github.com/AdrianArtacho/SHOWING.git) | *A browser-based action-score player for distributed performance* | – |
| [🕹Sidebrain](https://github.com/AdrianArtacho/sidebrain-app.git) | **Sidebrain** is a lightweight, server-less flashcard web app that loads all content dynamically from a **public CSV/TSV URL** (for example a Google Sheets “Publish to web” export). | – |
| [🕹Stationen](https://github.com/AdrianArtacho/teach_Stationen.git) | This project renders **interactive image overlays** from a **public CSV file** (e.g. Google Sheets → CSV), using **pure client-side JavaScript**. | – |
| [🕹Timekeeper](https://github.com/AdrianArtacho/teach_timekeep.git) | *A simple, web-based timekeeper for workshops, classrooms, and rehearsals* | – |
